...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '正能量之光', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '爱心人士的正能量输出', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ysg.pink', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '粉红丝带,一束光,捐发,正能量', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '123@ysg.pink', // 邮箱地址 例如mail@tangly1024.com
